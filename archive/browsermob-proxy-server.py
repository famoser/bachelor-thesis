# this file creates a flask web application which allows to control the browsermob proxy
# it has the endpoints:
# - /start to create a new proxy instance
# - /stop to end the proxy and kill all processes
...
browsermob_executable = "tools/browsermob-proxy-2.1.4/bin/browsermob-proxy"
port = "8081"
